...
Revision ID: fd632e3d3567
Revises: a184ff4d6694
Create Date: 2025-03-30 04:30:27.852912
...
revision: str = 'fd632e3d3567'
down_revision: Union[str, None] = 'a184ff4d6694'
...
def upgrade() -> None:
    ...
    op.drop_constraint('nodos_sensores_id_iot_gateway_fkey', 'nodos_sensores', type_='foreignkey')
