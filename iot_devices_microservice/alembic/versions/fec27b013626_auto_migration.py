...
Revision ID: fec27b013626
Revises: 04dcbd4554cd
Create Date: 2025-03-30 03:51:17.727381
...
revision: str = 'fec27b013626'
down_revision: Union[str, None] = '04dcbd4554cd'
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['id_node'], ['nodos_sensores.id'], name='sensores_id_node_fkey'),
    ...
    sa.ForeignKeyConstraint(['id_iot_gateway'], ['iot_gateways.id'], name='nodos_sensores_id_iot_gateway_fkey', ondelete='SET NULL'),
