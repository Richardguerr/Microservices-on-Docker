...
CREATE INDEX idx_nodos_sensores_gateway ON nodos_sensores(id_iot_gateway);
CREATE INDEX idx_sensores_node ON sensores(id_node);
CREATE INDEX idx_sensores_variable ON sensores(variable);
CREATE INDEX idx_nodos_zone_category ON nodos_sensores(zone_category);
